...
<div class="swiper-button-next"></div> -->
  ...
  <?php if (ICL_LANGUAGE_CODE == 'en') { ?>
    <!-- 'en'; -->
    <?php if (have_rows('en:_find_us')) : ?>
      <?php while (have_rows('en:_find_us')) : the_row(); ?>
              ...
              <div id="v-slider" class="v-slider d-none d-md-block">
                ...
                <div class="swiper swiper-v">
                  ...
                  <div class="swiper-wrapper">
                    <!-- Slides -->
                    <div class="swiper-slide">
                      <img src="<?php echo get_theme_file_uri(); ?>/images/v-slide-1.png" alt="slide 1">
                    ...
                    <div class="swiper-slide">
                      <img src="<?php echo get_theme_file_uri(); ?>/images/v-slide-2.png" alt=" slide 2">
                    ...
                    <div class="swiper-slide">
                      <img src="<?php echo get_theme_file_uri(); ?>/images/v-slide-3.png" alt=" slide 3">
