	...
	*/
	...
	(function ($) {
	  ...
	  $(document).ready(function () {
	    ...
	    const data1 = new CountUp('data-1', 691284, {
	      startVal: 100000,
	      duration: 25
	    });
	    const data2 = new CountUp('data-2', 255453, {
	      startVal: 100000,
	      duration: 25
	    });
	    const data3 = new CountUp('data-3', 2541038, {
	      startVal: 100000,
	      duration: 25
	    });
	    const data4 = new CountUp('data-4', 87622, {
	      startVal: 50000,
	      duration: 25
	    ...
	    $('#products').on('change', function () {
	      ...
	      if (frequencyVal === '1') {
	        switch (this.value) {
	          ...
	          case '6':
	            simulaData1.update(23); // simulaData2.update(23 * 345);

	            simulaData2.update(5 * 345); // simulaData3.update(23 * 1141);
	    ...
	    new Swiper__default["default"]('.swiper-delivery', {
	      slidesPerView: "auto",
	      // loop: true,
	      navigation: {
	        nextEl: '.next-green',
	    ...
	    new Swiper__default["default"]('.swiper-delivery-purple', {
	      slidesPerView: "auto",
	      // loop: true,
	      navigation: {
	        nextEl: '.next-purple',
	    ...
	    new Swiper__default["default"]('.swiper-team', {
	      autoplay: false,
	      grabCursor: true,
	      mousewheel: false,
	      slidesPerView: "auto",
	...
	(function ($) {
	  ...
	  if (document.querySelector('#switchView')) {
	    ...
	    let pointOfSaleActive = !switchView.checked; // Label's Action
	...
	(function ($) {
	  ...
	  document.querySelector(".dropbtn-shop");
	  document.querySelector(".dropbtn-brand"); // if (selectShop || selectBrand) {
