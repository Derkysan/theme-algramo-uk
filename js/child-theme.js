	...
	(function ($) {
	  ...
	  $(window).on('load', function () {
	    ...
	    marquee.forEach(el => {
	      ...
	      let rate = 200; // get the width of the element

	      let distance = el.clientWidth; // get the margin-right of the element

	      let style = window.getComputedStyle(el);
	      let marginRight = parseInt(style.marginRight) || 0; // get the total width of the element

	      let totalDistance = distance + marginRight; // get the duration of the animation 
	      // for a better explanation, see the quoted codepen in the first comment

	      let time = totalDistance / rate; // get the parent of the element
	    ...
	    const simulaData1 = new CountUp('simulaData1', 7, {
	      startVal: 0
	    });
	    const simulaData2 = new CountUp('simulaData2', 2, {
	      startVal: 10,
	      suffix: 'gr'
	    });
	    const simulaData3 = new CountUp('simulaData3', 465, {
	      startVal: 56,
	      suffix: 'gr'
	    });
	    simulaData1.start();
