	...
	*/
	...
	(function ($) {
	  ...
	  $(window).on('load', function () {
	    ...
	    const data1 = new CountUp('data-1', 2, {
	      startVal: 100,
	      suffix: 'M'
	    });
	    const data2 = new CountUp('data-2', 2, {
	      startVal: 100,
	      suffix: 'T',
	      duration: 4
	    });
	    const data4 = new CountUp('data-4', 430, {
	      startVal: 50
	    });
	    const data5 = new CountUp('data-5', 15, {
	      startVal: 0
	    });
	    const data6 = new CountUp('data-6', 356, {
	      startVal: 65
	    });
	    const data7 = new CountUp('data-7', 6, {
	      startVal: 15
	    });
